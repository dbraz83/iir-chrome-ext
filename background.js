                                            ...
                                            chrome.storage.local.get('iir_querytime', function (result) {
                                                ...
                                                chrome.cookies.get({ url: 'https://www.google.com', name: 'username' }, function (comCookie) {
                                                    ...
                                                    chrome.cookies.get({ url: 'https://www.google.co.uk', name: 'username' }, function (ukCookie) {
                                                        ...
                                                        csvContent += "StudyCode,Age,Nationality,Course,Gender,Language,Language Detail,IT Use,Internet Use,Search Engine Use,Search Engine Queries, Web Search Results, Website Information, Search Engine Preference,Search Engine Detail,Email Update,Email Detail" + "\r\n";
                                                        if (finalPreStudy != null) {
                                                            ...
                                                            csvContent += (finalPreStudy.studyCode != null ? finalPreStudy.studyCode : 'Unknown') + ',' + (finalPreStudy.age != null ? finalPreStudy.age : 'Unknown') + ',' + (finalPreStudy.nationality != null ? finalPreStudy.nationality : 'Unknown') + ',' + (finalPreStudy.course != null ? finalPreStudy.course : 'Unknown') + ',' + (finalPreStudy.gender != null ? finalPreStudy.gender : 'Unknown') + ',' + (finalPreStudy.language != null ? finalPreStudy.language : 'Unknown') + ',' + (finalPreStudy.languageText != null ? finalPreStudy.languageText : 'Unknown') + ',' + (finalPreStudy.itUse != null ? finalPreStudy.itUse : 'Unknown') + ',' + (finalPreStudy.internetUse != null ? finalPreStudy.internetUse : 'Unknown') + ',' + (finalPreStudy.searchEngineUse != null ? finalPreStudy.searchEngineUse : 'Unknown') + ',' + (finalPreStudy.query != null ? finalPreStudy.query : 'Unknown') + ',' + (finalPreStudy.result != null ? finalPreStudy.result : 'Unknown') + ',' + (finalPreStudy.infoWeb != null ? finalPreStudy.infoWeb : 'Unknown') + ',' + (finalPreStudy.searchEnginePreference != null ? finalPreStudy.searchEnginePreference : 'Unknown') + ',' + (finalPreStudy.searchEngineText != null ? finalPreStudy.searchEngineText : 'Unknown') + ',' + (finalPreStudy.emailUpdate != null ? finalPreStudy.emailUpdate : 'Unknown') + ',' + (finalPreStudy.updateText != null ? finalPreStudy.updateText : 'Unknown') + ',' + "\r\n";
                                                        }
